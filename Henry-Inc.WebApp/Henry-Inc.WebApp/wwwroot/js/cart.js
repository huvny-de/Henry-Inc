            ...
            success: function (res) {
                ...
                $.each(res, function (i, item) {
                    ...
                    html += "<tr>"
                        ...
                        + "<td><div class=\"input-append\"><input class=\"span1\" style=\"max-width: 34px;min-height: 47.33px !important;\" placeholder=\"1\" id=\"txt_quantity_" + item.productId + "\" value=\"" + item.quantity + "\" size=\"16\" type=\"text\">"
