...
namespace Henry_Inc.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               new AppConfig() { Key = "HomeTitle", Value = "This is home page of Henry_Inc" },
               new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of Henry_Inc" },
               new AppConfig() { Key = "HomeDescription", Value = "This is description of Henry_Inc" }
               );
